...
class ExplainableFeatureExtractor(BaseFeatureExtractor):
    def getExtraFeat(self, records):
        self.records_ma = records[:, self.fieldMap['ma']]
        self.records_ex = records[:, self.fieldMap['exchange_rate']]
        self.records_ltsz = records[:, self.fieldMap['ltsz']]
        self.records_zjlr = records[:, self.fieldMap['zjlr']]
        self.records_ydjl = records[:, self.fieldMap['ydjl']]
