...
public class DBRecord {
    ...
    float cashStrength1;    // unit: percent, 资金力度
    float cashStrength3;
    float cashStrength5;
    float cashStrength10;
    int cashRed3;           // unit: day, 资金飘红
    int cashRed5;
    int cashRed10;
    int cashRed20;

    float hdJingLiang;      // unit: vol
    float hdCashStrength1;  // unit: percent, 隐单力度
    float hdCashStrength3;
    float hdCashStrength5;
    float hdCashStrength10;
    int hdCashRed3;         // unit: day, 隐单飘红
    int hdCashRed5;
    int hdCashRed10;
    int hdCashRed20;
    ...
    float ddy;
    float ddz;
    int net;                // unit: 10,000, 净额
    int diffActionXBig;           // unit: vol, 特大差量
    int diffActionBig;
    int diffActionMid;
    int diffActionSmall;
    float strength;
    ...
    public float getMaFuquan() {
        return maFuquan;
    }

    public void setMaFuquan(float maFuquan) {
        this.maFuquan = maFuquan;
    }
}
